"""System-prompt construction (backend/app/prompt.py) — the per-deployment "which
...
live read of `ipeds_years()` (backend/app/tools/sql.py's non-raising probe), inserted
