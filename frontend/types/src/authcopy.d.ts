export declare function detailText(detail: any): string;
export declare const SESSION_EXPIRED = "Your session expired. Sign in again to pick up where you left off \u2014 your chats are saved.";
