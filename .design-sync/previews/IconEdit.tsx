...
import { IconEdit } from "ipeds-query-web";
...
export const Default = () => <IconEdit size={24} />;
...
export const InheritsColor = () => (
  <span style={{ display: "inline-flex", gap: 14, alignItems: "center" }}>
    <span style={{ color: "var(--accent)" }}><IconEdit size={24} /></span>
    <span style={{ color: "var(--ochre)" }}><IconEdit size={24} /></span>
    <span style={{ color: "var(--danger)" }}><IconEdit size={24} /></span>
    <span style={{ color: "var(--muted)" }}><IconEdit size={24} /></span>
  </span>
);
