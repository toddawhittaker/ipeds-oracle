...
import { IconMaximize } from "ipeds-query-web";
...
export const Default = () => <IconMaximize size={24} />;
...
export const InheritsColor = () => (
  <span style={{ display: "inline-flex", gap: 14, alignItems: "center" }}>
    <span style={{ color: "var(--accent)" }}><IconMaximize size={24} /></span>
    <span style={{ color: "var(--ochre)" }}><IconMaximize size={24} /></span>
    <span style={{ color: "var(--danger)" }}><IconMaximize size={24} /></span>
    <span style={{ color: "var(--muted)" }}><IconMaximize size={24} /></span>
  </span>
);
